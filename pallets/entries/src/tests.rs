...
#[test]
fn revoke_registry_entry_should_work_for_valid_creator() {
	let admin = ACCOUNT_00;
	let creator = ACCOUNT_01;
	let registry = [2u8; 256].to_vec();
...
#[test]
fn revoke_registry_entry_should_work_for_valid_admin() {
	let creator = ACCOUNT_00;
	let registry = [2u8; 256].to_vec();
...
#[test]
fn revoke_registry_entry_should_fail_for_non_registry_entry_creator() {
	let admin = ACCOUNT_00;
	let creator = ACCOUNT_01;
	let non_creator = ACCOUNT_02;
	let registry = [2u8; 256].to_vec();
...
#[test]
fn revoke_registry_entry_should_fail_for_non_registry_admin() {
	let admin = ACCOUNT_00;
	let creator = ACCOUNT_01;
	let invalid_admin = ACCOUNT_02;
	let registry = [2u8; 256].to_vec();
