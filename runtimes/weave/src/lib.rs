...
impl_runtime_weights!(cord_weave_runtime_constants, MAXIMUM_BLOCK_WEIGHT);
...
parameter_types! {
	...
	pub const PreimageBaseDeposit: Balance = 1 * WAY;
	pub const PreimageByteDeposit: Balance = 1 * MILLIUNITS;
